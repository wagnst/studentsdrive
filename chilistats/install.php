...
// Tabellenstruktur für Tabelle `...Day`
	...
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats Days by ChilliScripts';");
...
// Tabellenstruktur für Tabelle `...IPs`
	...
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats IPs by ChilliScripts' ;");
...
// Tabellenstruktur für Tabelle `...Page`
	...
	`view` int(10) NOT NULL default '0',
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats Page by ChilliScripts';");
...
// Tabellenstruktur für Tabelle `...Referer`
	...
	`view` int(10) NOT NULL default '0',
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats Referer by ChilliScripts' ;");
...
// Tabellenstruktur für Tabelle `...Keyword`
	...
	`view` int(10) NOT NULL default '0',
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats Keyword by ChilliScripts' ;");
...
// Tabellenstruktur für Tabelle `...Language`
	...
	`view` int(10) NOT NULL default '0',
	PRIMARY KEY  (`id`)
	) ENGINE=MyISAM COMMENT='ChilliStats Language by ChilliScripts' ;");
